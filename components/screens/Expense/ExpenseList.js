...
import { Appbar, Avatar, Button, Card, Title, Paragraph, Dialog, Portal, Provider } from 'react-native-paper';
...
function ExpenseList({ navigation, route }) {
    ...
    return (
        <NativeBaseProvider>
            ...
            <Button style={styles.addbutton} onPress={() => { navigation.navigate("AddNewExpense", { Icon: route.params.Icon, Iconfamily: route.params.Iconfamily, Id: route.params.Id, UserId: route.params.UserId }) }}><Text style={{ color: "white" }}>Add</Text></Button>
        </NativeBaseProvider>
    );
}
