...
function IncomeData({ navigation }) {
    ...
    useEffect(() => {
        GetData((auth()._user.email.split("@")[0] + "-Income").toString());
    }, []);
    ...
    return (
        <NativeBaseProvider>
            <Appbar.Header mode="small" elevated="false" style={[
                ...
                <Appbar.Content color="white" title={"Income Data"} />
            </Appbar.Header>
                        ...
                        chartData.length === 0
                            ...
                            <>
                                <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
                                    <Text style={{ color: "#34b27b" }}>Nodata Found !</Text>
                                </View>
                            </>
                            :
                            <View>
