...
function IncomeList({ navigation, route }) {
                ...
                },
                {
                    text: "OK", onPress: () => {
                        firestore()
                            ...
                            .delete()
                            .then(() => {
                                console.log('Income Category Deleted Successfuly !');
    ...
    return (
        <View style={{ flex: 1 }}>
            <Appbar.Header mode="small" elevated="false" style={[
                ...
                <Appbar.Action color="white" icon="delete-outline" onPress={() => { rmIncome(route.params.Id, route.params.UserId) }} />
            </Appbar.Header>
            {
                loading
                    ?
